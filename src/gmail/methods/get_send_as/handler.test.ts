...
function fakeGmail(
  ...
  captured: { params?: gmail_v1.Params$Resource$Users$Settings$Sendas$Get },
): gmail_v1.Gmail {
  return {
    users: {
      settings: {
        sendAs: {
          get: async (params: gmail_v1.Params$Resource$Users$Settings$Sendas$Get) => {
...
describe('get_send_as', () => {
  it('passes exact account parameters and projects the resource', async () => {
    const captured: { params?: gmail_v1.Params$Resource$Users$Settings$Sendas$Get } = {};
    const data = {
