...
function fakeGmail(
  data: object,
  captured: { params?: gmail_v1.Params$Resource$Users$Settings$Sendas$Smimeinfo$Delete },
): gmail_v1.Gmail {
  return {
    users: {
      settings: {
        sendAs: {
          smimeInfo: {
            delete: async (
              params: gmail_v1.Params$Resource$Users$Settings$Sendas$Smimeinfo$Delete,
            ) => {
...
describe('delete_smime_info', () => {
  it('passes exact account parameters and projects documented output', async () => {
    const captured: { params?: gmail_v1.Params$Resource$Users$Settings$Sendas$Smimeinfo$Delete } =
      {};
