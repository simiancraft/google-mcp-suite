...
function fakeGmail(
  data: object,
  captured: { params?: gmail_v1.Params$Resource$Users$Settings$Cse$Keypairs$Enable },
): gmail_v1.Gmail {
  return {
    users: {
      settings: {
        cse: {
          keypairs: {
            enable: async (params: gmail_v1.Params$Resource$Users$Settings$Cse$Keypairs$Enable) => {
...
describe('enable_cse_keypair', () => {
  it('passes exact account parameters and projects documented output', async () => {
    const captured: { params?: gmail_v1.Params$Resource$Users$Settings$Cse$Keypairs$Enable } = {};
