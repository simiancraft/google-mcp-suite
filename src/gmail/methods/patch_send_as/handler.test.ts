...
function fakeGmail(
  ...
  captured: { params?: gmail_v1.Params$Resource$Users$Settings$Sendas$Patch },
): gmail_v1.Gmail {
  return {
    users: {
      settings: {
        sendAs: {
          patch: async (params: gmail_v1.Params$Resource$Users$Settings$Sendas$Patch) => {
...
describe('patch_send_as', () => {
  it('passes exact account parameters and projects the resource', async () => {
    const captured: { params?: gmail_v1.Params$Resource$Users$Settings$Sendas$Patch } = {};
    const data = {
